...
const Footer = () => {
  ...
  return (
    <div className='pb-20'>
      <p className='w-full flex justify-center items-center pb-10 sm:text-4xl text-3xl font-bold'>Want to connect with me</p>
      <div className='flex justify-center items-center gap-10'>
        ...
        >
          ...
          {/* <img src="github.svg" className='h-10 w-10' lt="" /> */}
        </a>
      </div>
    </div>
  )
